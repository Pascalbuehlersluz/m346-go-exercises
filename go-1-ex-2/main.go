...
func main() {
	...
	var marathonInMiles = marathonInKM / mileInKM // Conversion from kilometers to miles
	fmt.Printf("a marathon is %.2f kilometres = %.2f miles long\n", marathonInKM, marathonInMiles)

	var boilingWaterCelsius = 100.0
	var boilingWaterFahrenheit = boilingWaterCelsius*9/5 + 32 // Conversion from Celsius to Fahrenheit
